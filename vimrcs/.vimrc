...
map <A-s> :mksession! ~/dotfiles/vimrcs/sessions/recent<cr>
map <leader>s :so ~/dotfiles/vimrcs/sessions/recent<cr>
...
let g:lightline = { 'colorscheme': 'wombat', 'tabline': {   'left': [ ['bufferline'] ] }, 'component_expand': {   'bufferline': 'LightlineBufferline', }, 'component_type': {   'bufferline': 'tabsel', }, 'component_function': {   'gitbranch': 'fugitive#head' }, }
